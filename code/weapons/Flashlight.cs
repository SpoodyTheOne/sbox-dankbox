...
partial class Flashlight : Weapon
{
	...
	public override void CreateViewModel()
	{
		...
		viewLight.SetParent( ViewModelEntity, "light", new Transform( LightOffset, Rotation.Identity.RotateAroundAxis( Vector3.Forward, -80 ) ) );
	...
	private SpotLightEntity CreateLight()
	{
		var light = new SpotLightEntity
		{
			...
			FogStength = 1.0f,
			Owner = Owner,
			LightCookie = Texture.Load( "materials/effects/thicc.vtex" ),
		};
